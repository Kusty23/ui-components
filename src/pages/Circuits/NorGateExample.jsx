...
import { Node, SwitchNode, NotGate, OrGate, NorGate } from "./Nodes.js";

let nodes = [];
let selected;

export default function NorGateExample(props) {
  // Canvas
  ...
  return (
    <>
      ...
      <div className="span--6">
        <h3>NOR Gate</h3>
        <p>
          We also have the NOR gate. It is just the opposite of the OR gate.
        </p>
      </div>
    </>
  );
